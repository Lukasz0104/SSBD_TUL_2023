...
public class AppExceptionMapper implements ExceptionMapper<AppBaseException> {
    ...
    public Response toResponse(AppBaseException appBaseException) {
        ...
        Map<Class<?>, Response.Status> map = Map.of(AppConflictException.class, Response.Status.CONFLICT, AppBadRequestException.class, Response.Status.BAD_REQUEST, AppUnauthorizedException.class, Response.Status.UNAUTHORIZED, AppNotFoundException.class, Response.Status.NOT_FOUND);
