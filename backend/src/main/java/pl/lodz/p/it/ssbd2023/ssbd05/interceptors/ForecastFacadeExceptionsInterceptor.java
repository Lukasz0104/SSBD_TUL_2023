...
import pl.lodz.p.it.ssbd2023.ssbd05.exceptions.conflict.ForecastAlreadyExistsException;

public class ForecastFacadeExceptionsInterceptor {
    ...
    public Object intercept(InvocationContext ictx) throws Exception {
        try {
            ...
            do {
                ...
                if (exceptionMessage.contains("unq_forecast_0")) {
