...
public interface BuildingManagerLocal extends CommonManagerInterface {
    ...
    List<Report> getBuildingReports(Long id) throws AppBaseException;

    List<Place> getBuildingPlaces(Long id) throws AppBaseException;

    Report getBuildingReportByYear(Long id, Long year) throws AppBaseException;

    void createBuilding() throws AppBaseException;
}
